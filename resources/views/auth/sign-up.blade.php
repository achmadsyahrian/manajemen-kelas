					...
					<div class="card-body">
						...
						<form action="/sign-up" method="POST">
							...
							<div class="form-group mb-4">
								...
								<input type="email" class="form-control @error('email') is-invalid @enderror" autocomplete="off" id="Email" name="email" value="{{ old('email') }}" placeholder="">
								@error('email')
									 <x-invalid-feedback>{{ $message }}</x-invalid-feedback>
								@enderror
							</div>
							<div class="form-group mb-4">
								...
								<input type="text" class="form-control @error('phone') is-invalid @enderror" autocomplete="off" id="Phone" name="phone" value="{{ old('phone') }}" placeholder="">
								@error('phone')
									 <x-invalid-feedback>{{ $message }}</x-invalid-feedback>
								@enderror
							</div>
