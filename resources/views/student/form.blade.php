                  ...
                  <div class="col-sm-6">
                     <div class="form-group mb-4">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ isset($student) ? $student->user->name : old('name') }}" id="name">
                        @error('name')
                        <x-forms.invalid-feedback>{{ $message }}</x-forms.invalid-feedback>
                        @enderror
                     </div>
                  ...
                  <div class="col-sm-6">
                     <div class="form-group mb-4">
                        ...
                        <input type="text" name="username" class="form-control @error('username') is-invalid @enderror"
                           value="{{ isset($student) ? $student->user->username : old('username') }}" id="username">
                        @error('username')
                        <x-forms.invalid-feedback>{{ $message }}</x-forms.invalid-feedback>
                        @enderror
                     </div>
                  ...
                  <div class="col-sm-6">
                     <div class="form-group mb-4">
                        ...
                        <input type="number" name="nim" class="form-control @error('nim') is-invalid @enderror"
                           value="{{ isset($student) ? $student->nim : old('nim') }}" id="nim">
                        @error('nim')
                        <x-forms.invalid-feedback>{{ $message }}</x-forms.invalid-feedback>
                        @enderror
                     </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group mb-4">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                           value="{{ isset($student) ? $student->phone : old('phone') }}" id="phone">
                        @error('phone')
                        <x-forms.invalid-feedback>{{ $message }}</x-forms.invalid-feedback>
                        @enderror
                     </div>
                  ...
                  <div class="col-sm-6">
                     <div class="form-group mb-4">
                        ...
                        <input type="text" name="email" class="form-control @error('email') is-invalid @enderror"
                           value="{{ isset($student) ? $student->user->email : old('email') }}" id="email">
                        @error('email')
                        <x-forms.invalid-feedback>{{ $message }}</x-forms.invalid-feedback>
                        @enderror
                     </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group mb-4">
                        <select id="gender" name="gender" class="form-control">
                           <option value="pria" {{ (isset($student) && $student->gender == 'pria') ? 'selected' : ''
                              }}>Pria</option>
                           <option value="wanita" {{ (isset($student) && $student->gender == 'wanita') ? 'selected' : ''
                              }}>Wanita</option>
                        </select>
                     </div>
                  </div>
